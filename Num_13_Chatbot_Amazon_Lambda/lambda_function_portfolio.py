    ...
    if age is not None:
        ...
        if age < 0: 
            return build_validation_result(
                False,
                "age",
                "The age number provided is incorrect, please provide a correct age number."
            )        
            ...
            return build_validation_result(
                False,
                "age",
                "Sorry, this services is currently only avaliable for users whoes age is less than 65."
    ...
    if investment_amount is not None:
        ...
        # The investment_amount should be equal to or greater than 5000.
            ...
            return build_validation_result(
                False,
                "investmentAmount",
                "Sorry, the minimum investment amount is 5000, please provide a higher investment to start this service. "
